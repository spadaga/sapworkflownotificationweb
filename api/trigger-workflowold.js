export default async function handler(req, res) {
  console.log("🚀 [TRIGGER] ============X WORKFLOW TRIGGER STARTED ============")
  ...
  try {
    ...
    // Use real SAP data structure
    const workflowData = {
      TASK_TITLE: "Verify General Journal Entry 100000155 GMM1 2025",
      Status: "READY",
      INST_ID: instanceId,
      TASKDETAILS:
        " #$# Document Type : G/L Account Document #$# Company Code : GM Manufacturing #$# Amount : 1.700,00 USD",
      CREATED_BY_NAME: "Ayush Agrawal",
      CREATED_ON: "2025-06-10T11:05:47.000",
      INBOXURL:
        inboxUrl ||
        "https://yawss4hsbx.sapyash.com:44301/sap/bc/ui2/flp?sap-client=100&sap-language=EN#WorkflowTask-displayInbox",
    }
...
function createTeamsInlineCard(workflow, isLiveData = true) {
  ...
  try {
    ...
    console.log(
      "📋 [CARD] Action types:",
      cardContent.actions.map((a) => a.type),
    )
